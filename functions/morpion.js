const clickMORPION = document.getElementById('linkMORPION')

document.addEventListener('click', function (e) {
    if (e.target && e.target.id == 'linkMORPION') {
        while (document.body.lastElementChild) {
            document.body.removeChild(document.body.lastElementChild);
        }

        var textExplicationImg = 'Page d\'accueil du morpion'
        var txtExplicationProjet = 'Ce projet consistait à coder le jeu très populaire du morpion, ce jeu se joue uniquement contre un humain.'
        ...
        var txtProjects = document.createTextNode('MORPION')
        ...
        img1.src = './images/MORPION/Morpion_Presentation.PNG'

        var aImg1 = document.createElement('a')
        aImg1.href = './images/MORPION/Morpion_Presentation.PNG'

        var img2 = document.createElement('img')
        img2.id = 'morpion1'
        img2.className = 'imgProject'
        img2.src = './images/MORPION/Morpion_Cercle_Gagne.PNG'

        var aImg2 = document.createElement('a')
        aImg2.href = './images/MORPION/Morpion_Cercle_Gagne.PNG'

        var img3 = document.createElement('img')
        img3.id = 'morpion2'
        img3.className = 'imgProject'
        img3.src = './images/MORPION/Morpion_Croix_Gagne.PNG'

        var aImg3 = document.createElement('a')
        aImg3.href = './images/MORPION/Morpion_Croix_Gagne.PNG'

        var img4 = document.createElement('img')
        img4.id = 'morpion3'
        img4.className = 'imgProject'
        img4.src = './images/MORPION/Morpion_Match_Nul.PNG'

        var aImg4 = document.createElement('a')
        aImg4.href = './images/MORPION/Morpion_Match_Nul.PNG'
        ...
        nextArrow.addEventListener("click", () => {
            ...
            switch (i + 1) {
                case 1:
                    textExplicationImg = 'Message de victoire lorsque la personne qui joue les cercles gagne'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 2:
                    textExplicationImg = 'Message de victoire lorsque la personne qui joue les croix gagne'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 3:
                    textExplicationImg = 'Message lorsqu\'un match nul se produit'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 4:
                    textExplicationImg = 'Page d\'accueil du morpion'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
            ...
            if (i < images.length - 1) {
                const morpion = document.getElementById("morpion" + i);
                morpion.className = "imgCurrent"
                i++
                morpion.className = 'imgProject'
                const morpion1 = document.getElementById("morpion" + i);
                morpion1.className = "imgCurrent"
            } else {
                const morpion1 = document.getElementById("morpion" + i);
                morpion1.className = "imgProject"
                i = 0
                const morpion = document.getElementById("morpion" + i)
                morpion.className = "imgCurrent"
            }
