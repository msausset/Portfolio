const clickRapportStage1 = document.getElementById('linkFirstStage')

document.addEventListener('click', function (e) {
    if (e.target && e.target.id == 'linkFirstStage') {
        ...
        var iFrameStage1 = document.createElement('iframe')
        iFrameStage1.src = './images/RAPPORT_STAGE/BTS_SIO_Rapport_de_stage_1ere_année_(1).pdf'

        divContainer.appendChild(iFrameStage1)
