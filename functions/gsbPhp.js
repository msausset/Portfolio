const clickGSBPHP = document.getElementById('linkGSBPHP')


document.addEventListener('click', (e) => {
    if (e.target && e.target.id == 'linkGSBPHP') {

        while (document.body.lastElementChild) {
            document.body.removeChild(document.body.lastElementChild);
        }

        var textExplicationImg = 'Page d\'identification en tant que comptable (administrateur) ou médecin (visiteur)'
        var txtExplicationProjet = 'Le laboratoire Galaxy Swiss Bourdin (GSB) engage des visiteurs qui sont amenés à se déplacer. ' +
            'Leurs déplacements et actions de terrain engendrent des frais qui doivent être pris en charge par la comptabilité : ' +
            'ils disposent d’une application pour saisir leurs frais. ' +
            'L’application doit maintenant proposer un menu comptable afin de suivre les frais enregistrés par les visiteurs. ' +
            '(La première étape afin que les comptables accèdent à l\'application remboursement des frais est l\'authentification. ' +
            'Les utilisateurs ont plusieurs rôle et selon leur rôle il accède à un accueil différent.)'
        ...
        var txtProjects = document.createTextNode('GSB PHP MVC')
        ...
        img1.src = './images/GSB_PHP/GSB_MVC_Authentification.png'

        var aImg1 = document.createElement('a')
        aImg1.href = './images/GSB_PHP/GSB_MVC_Authentification.png'

        var img2 = document.createElement('img')
        img2.id = 'gsbphp1'
        img2.className = 'imgProject'
        img2.src = './images/GSB_PHP/GSB_MVC_Recherche_Validation.png'

        var aImg2 = document.createElement('a')
        aImg2.href = './images/GSB_PHP/GSB_MVC_Recherche_Validation.png'

        var img3 = document.createElement('img')
        img3.id = 'gsbphp2'
        img3.className = 'imgProject'
        img3.src = './images/GSB_PHP/GSB_MVC_Suivi_Fiches.png'

        var aImg3 = document.createElement('a')
        aImg3.href = './images/GSB_PHP/GSB_MVC_Suivi_Fiches.png'

        var img4 = document.createElement('img')
        img4.id = 'gsbphp3'
        img4.className = 'imgProject'
        img4.src = './images/GSB_PHP/GSB_MVC_Remboursement_Fiches.jpg'

        var aImg4 = document.createElement('a')
        aImg4.href = './images/GSB_PHP/GSB_MVC_Remboursement_Fiches.jpg'

        var img5 = document.createElement('img')
        img5.id = 'gsbphp4'
        img5.className = 'imgProject'
        img5.src = './images/GSB_PHP/GSB_MVC_Validation_Fiches.jpg'

        var aImg5 = document.createElement('a')
        aImg5.href = './images/GSB_PHP/GSB_MVC_Validation_Fiches.jpg'

        var img6 = document.createElement('img')
        img6.id = 'gsbphp5'
        img6.className = 'imgProject'
        img6.src = './images/GSB_PHP/GSB_MVC_Validation_Fiches_HF.jpg'

        var aImg6 = document.createElement('a')
        aImg6.href = './images/GSB_PHP/GSB_MVC_Validation_Fiches_HF.jpg'
        ...
        nextArrow.addEventListener("click", () => {
            ...
            switch (i + 1) {
                case 1:
                    textExplicationImg = 'Recherche du médecin et du mois souhaité'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 2:
                    textExplicationImg = 'Suivi de la fiche de frais du médecin choisi'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 3:
                    textExplicationImg = 'Validation de la fiche de frais'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 4:
                    textExplicationImg = 'Validation de la fiches de frais et des éléments hors forfait'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 5:
                    textExplicationImg = 'Cas d\'un élément hors forfait refusé par le comptable'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
                case 6:
                    textExplicationImg = 'Page d\'identification en tant que comptable (administrateur) ou médecin (visiteur)'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
            ...
            if (i < images.length - 1) {
                ...
                gsbphp.className = "imgCurrent"
                i++
                gsbphp.className = 'imgProject'
                const gsbphp1 = document.getElementById("gsbphp" + i);
                gsbphp1.className = "imgCurrent"
            } else {
                const gsbphp1 = document.getElementById("gsbphp" + i);
