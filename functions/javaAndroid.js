const clickJAVAANDROID = document.getElementById('linkJAVAANDROID')

document.addEventListener('click', function (e) {
    if (e.target && e.target.id == 'linkJAVAANDROID') {
        while (document.body.lastElementChild) {
            document.body.removeChild(document.body.lastElementChild);
        }

        var textExplicationImg = 'Exportation des fiches de frais du visiteur en CSV'
        var txtExplicationProjet = 'L\'application Java Android fonctionne uniquement sur tablette et smartphone et possède ' +
            'les mêmes caractéristiques que l\'application Java Web, il permet de lister les médecins par département ou par nom.'
        ...
        var txtProjects = document.createTextNode('JAVA ANDROID')
        ...
        img1.id = 'javaandroid0'
        img1.className = 'imgCurrent'
        img1.src = './images/JAVA_ANDROID/Java_Android_Recherche_Nom.png'

        var aImg1 = document.createElement('a')
        aImg1.href = './images/JAVA_ANDROID/Java_Android_Recherche_Nom.png'

        var img2 = document.createElement('img')
        img2.id = 'javaandroid1'
        img2.className = 'imgProject'
        img2.src = './images/JAVA_ANDROID/Java_Android_Tri_Departement.png'

        var aImg2 = document.createElement('a')
        aImg2.href = './images/JAVA_ANDROID/Java_Android_Tri_Departement.png'

        var img3 = document.createElement('img')
        img3.id = 'javaandroid2'
        img3.className = 'imgProject'
        img3.src = './images/JAVA_ANDROID/Java_Android_Tri_Nom.png'

        var aImg3 = document.createElement('a')
        aImg3.href = './images/JAVA_ANDROID/Java_Android_Tri_Nom.png'
        ...
        nextArrow.addEventListener("click", () => {
            ...
            switch (i + 1) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    textExplicationImg = 'Barre de recherche pour lister les médecins correspondants'
                    txtExpImg = document.createTextNode(`${textExplicationImg}`)
                    pTxtExpImg.innerHTML = ''
                    pTxtExpImg.appendChild(txtExpImg)
                    break;
            ...
            if (i < images.length - 1) {
                const javaandroid = document.getElementById("javaandroid" + i);
                javaandroid.className = "imgCurrent"
                i++
                javaandroid.className = 'imgProject'
                const javaandroid1 = document.getElementById("javaandroid" + i);
                javaandroid1.className = "imgCurrent"
            } else {
                const javaandroid1 = document.getElementById("javaandroid" + i);
                javaandroid1.className = "imgProject"
                i = 0
                const javaandroid = document.getElementById("javaandroid" + i)
                javaandroid.className = "imgCurrent"
            }
